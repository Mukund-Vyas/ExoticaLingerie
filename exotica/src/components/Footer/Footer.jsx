                ...
                <div className="footer-content">
                    ...
                    <div className="footer-menu">
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost:3000/">Bras</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Nightwear</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Activewear</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Panties</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Lingerie Set</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Winterwear</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Beauty</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Lingerie Sale & Offer</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Swimwear</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-menu">
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost:3000/">Shipping Policy</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="http://localhost:3000/">Returns & Exchange Policy</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Track your Order</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Discreet Packaging</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Payment Policy</a>
                            </li>
                            <li>
                    ...
                    <div className="footer-menu">
                        <ul>
                            <li>Quick Links</li>
                            <li>
                                <a href="http://localhost:3000/">About Exotica Lingerie</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Blogs</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Find Your Fit</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Bra Size Calculator</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Shop By Sizes</a>
                            </li>
                            <li>
                                <a href="http://localhost:3000/">Shop By Colours</a>
                            </li>
                            <li>
                    ...
                    <div className="footer-contact-details">
                        <div className="location">
                            ...
                            <p>
                                ...
                                <a href="mailto:support@exoticalingerie.in">
