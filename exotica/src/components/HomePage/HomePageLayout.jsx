...
const HomePageLayout = () => {
  ...
  const images = [
    ...
    '/Images/Posters/ex-carousel1.webp',
    '/Images/Posters/ex-carousel2.webp',
    '/Images/Posters/ex-carousel3.webp',
    '/Images/Posters/ex-carousel4.webp',
    '/Images/Posters/ex-carousel5.webp',
  ];
