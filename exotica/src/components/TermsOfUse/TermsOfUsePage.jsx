      ...
      subTabs: [
        {
          no: "1",
          heading: "Pricing:",
          description: "All prices are listed in USD and are subject to change without notice. We are not responsible for typographical errors."
        },
        {
          no: "2",
          heading: "Payment Methods:",
          description: "We accept various payment methods, including credit cards, debit cards, and PayPal. Payment must be received before your order is processed."
        },
      ]
    },
    {
      ...
      subTabs: [
        {
          ...
          description: "For any questions or concerns regarding these terms and conditions, please contact us at support@exoticalingerie.com or call +91 9978605400"
        },
      ]
    },
    {
  ...
  return (
    <div className=' bg-gradient-to-b from-[#ffd9ea] to-[#fdf2f8]'>
      <div className='container max-w-screen-lg mx-auto py-8'>
        <div>
          <h1 className=' text-[36px] font-semibold'>Terms and Conditions for Exotica Lingerie</h1>
        </div>
        <hr className='mt-2 bg-black h-[2px]' />
        <div className=' mt-4 flex flex-col gap-4'>
          <div className=''>
            <p className='description text-justify'>
              Welcome to Exotica Lingerie. These terms and conditions outline the rules and regulations for the use of our website and services. By accessing this website and making a purchase, you accept these terms and conditions in full. If you disagree with any part of these terms and conditions, please do not use our website.
            </p>
          </div>
          {
            data?.map((item, index) => (
